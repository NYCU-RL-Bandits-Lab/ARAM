...
def run():
    ...
    parser.add_argument("--wandb-project-name", type=str, default="wandb_proj", help="the wandb's project name")
    parser.add_argument("--wandb-entity", type=str, default="ARAM", help="the entity (team) of wandb's project")
    parser.add_argument("--wandb-info", type=str, default="ARAM", help="the info of wandb's project")
