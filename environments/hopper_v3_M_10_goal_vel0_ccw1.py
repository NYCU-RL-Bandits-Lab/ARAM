...
class HopperEnv_M_10_vel0_ccw1(mujoco_env.MujocoEnv, utils.EzPickle):
    def __init__(
        self,
        xml_file="hopper.xml",
...
register(id='MO_hopper_M_10_goal_vel0_ccw1-v0', entry_point='environments.hopper_v3_M_10_goal_vel0_ccw1:HopperEnv_M_10_vel0_ccw1')
