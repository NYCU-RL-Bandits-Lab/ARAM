...
class HopperEnv_M_10_vel3_ccw_01(mujoco_env.MujocoEnv, utils.EzPickle):
    def __init__(
        self,
        xml_file="hopper.xml",
...
register(id='MO_hopper_M_10_goal_vel3_ccw_01-v0', entry_point='environments.hopper_v3_M_10_goal_vel3_ccw_01:HopperEnv_M_10_vel3_ccw_01')
