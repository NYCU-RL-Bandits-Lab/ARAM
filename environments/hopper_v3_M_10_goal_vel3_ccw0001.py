...
class HopperEnv_M_10_vel3_ccw0001(mujoco_env.MujocoEnv, utils.EzPickle):
    def __init__(
        self,
        xml_file="hopper.xml",
...
register(id='MO_hopper_M_10_goal_vel3_ccw0001-v0', entry_point='environments.hopper_v3_M_10_goal_vel3_ccw0001:HopperEnv_M_10_vel3_ccw0001')
