...
class HalfCheetahEnv_O_20(mujoco_env.MujocoEnv, utils.EzPickle):
    def __init__(
        self,
...
register(id='MO_half_cheetah_O_20-v0', entry_point='environments.half_cheetah_v3_O_20:HalfCheetahEnv_O_20')
