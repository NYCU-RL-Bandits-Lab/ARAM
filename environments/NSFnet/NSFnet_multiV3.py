...
from environments.NSFnet import sender_obs, config
from environments.NSFnet.simple_arg_parse import arg_or_default
inf_bw = 5000
bw_default = 50
MAX_CWND = 5000
MIN_CWND = 4
...
class Network():
    ...
    def run_for_dur(self, dur):
                ...
                if pack.path_num == 0:
                    if dropped:
                        ...
                        if sender.sender_ID == 0:
                            recv_total0 += 1
                        elif sender.sender_ID == 1:
                            recv_total1 += 1
                        elif sender.sender_ID == 2:
                            recv_total2 += 1
                        elif sender.sender_ID == 3:
                            recv_total3 += 1
                        elif sender.sender_ID == 4:
                            recv_total4 += 1
                        recv_total += 1
                ...
                if pack.path_num == 0:      
                    ...
                    if sender.can_send_packet():
                        ...
                        if ran_tmp == 0 and t[tosend_ID][topath_ID] > 0:
                            ...
                            t[tosend_ID][topath_ID] -= 1
                            pack = Packet(self.packet_counter, topath_ID, self.cur_time, 0, [0, 17, 6], "test1")
                            p[tosend_ID][topath_ID] += 1 / sender_.p1
                        elif ran_tmp == 2 and t[tosend_ID][topath_ID] > 0:
                            t[tosend_ID][topath_ID] -= 1
                            pack = Packet(self.packet_counter, topath_ID, self.cur_time, 0, [0, 17, 22, 27, 15], "test2")
                            p[tosend_ID][topath_ID] += 1 / sender_.p2
                        elif ran_tmp == 3 and t[tosend_ID][topath_ID] > 0:
                            t[tosend_ID][topath_ID] -= 1
                            pack = Packet(self.packet_counter, topath_ID, self.cur_time, 0, [0, 16, 19, 21, 23, 26, 28, 13], "test3")
                            p[tosend_ID][topath_ID] += 1 / sender_.p3
                        elif ran_tmp == 4 and t[tosend_ID][topath_ID] > 0:
                            t[tosend_ID][topath_ID] -= 1
                            pack = Packet(self.packet_counter, topath_ID, self.cur_time, 0, [7, 23, 25, 10], "test4")
                            p[tosend_ID][topath_ID] += 1 / sender_.p0
                        elif ran_tmp == 5 and t[tosend_ID][topath_ID] > 0:
                            t[tosend_ID][topath_ID] -= 1
                            pack = Packet(self.packet_counter, topath_ID, self.cur_time, 0, [7, 24, 30, 15], "test5")
                            p[tosend_ID][topath_ID] += 1 / sender_.p1
                        elif ran_tmp == 6 and t[tosend_ID][topath_ID] > 0:
                            t[tosend_ID][topath_ID] -= 1
                            pack = Packet(self.packet_counter, topath_ID, self.cur_time, 0, [7, 21, 19, 16, 1], "test6")
                            p[tosend_ID][topath_ID] += 1 / sender_.p2
                        elif ran_tmp == 7 and t[tosend_ID][topath_ID] > 0:
                            t[tosend_ID][topath_ID] -= 1
                            pack = Packet(self.packet_counter, topath_ID, self.cur_time, 0, [7, 24, 29, 13], "test7")
                            p[tosend_ID][topath_ID] += 1 / sender_.p3
                        elif ran_tmp == 8 and t[tosend_ID][topath_ID] > 0:
                            t[tosend_ID][topath_ID] -= 1
                            pack = Packet(self.packet_counter, topath_ID, self.cur_time, 0, [14, 29, 28, 12], "test8")
                            p[tosend_ID][topath_ID] += 1 / sender_.p0
                        elif ran_tmp == 9 and t[tosend_ID][topath_ID] > 0:
                            t[tosend_ID][topath_ID] -= 1
                            pack = Packet(self.packet_counter, topath_ID, self.cur_time, 0, [14, 30, 27, 22, 6], "test9")
                            p[tosend_ID][topath_ID] += 1 / sender_.p1
                        elif ran_tmp == 10 and t[tosend_ID][topath_ID] > 0:
                            t[tosend_ID][topath_ID] -= 1
                            pack = Packet(self.packet_counter, topath_ID, self.cur_time, 0, [14, 24, 21, 4], "test10")
                            p[tosend_ID][topath_ID] += 1 / sender_.p2
                        elif ran_tmp == 11 and t[tosend_ID][topath_ID] > 0:
                            t[tosend_ID][topath_ID] -= 1
                            pack = Packet(self.packet_counter, topath_ID, self.cur_time, 0, [14, 30, 27, 22, 20, 3], "test11")
                            p[tosend_ID][topath_ID] += 1 / sender_.p3
                        elif ran_tmp == 12 and t[tosend_ID][topath_ID] > 0:
                            t[tosend_ID][topath_ID] -= 1
                            pack = Packet(self.packet_counter, topath_ID, self.cur_time, 0, [12, 26, 25, 10], "test12")
                            p[tosend_ID][topath_ID] += 1 / sender_.p0
                        elif ran_tmp == 13 and t[tosend_ID][topath_ID] > 0:
                            t[tosend_ID][topath_ID] -= 1
                            pack = Packet(self.packet_counter, topath_ID, self.cur_time, 0, [12, 28, 29, 30, 15], "test13")
                            p[tosend_ID][topath_ID] += 1 / sender_.p1
                        elif ran_tmp == 14 and t[tosend_ID][topath_ID] > 0:
                            t[tosend_ID][topath_ID] -= 1
                            pack = Packet(self.packet_counter, topath_ID, self.cur_time, 0, [12, 26, 25, 22, 17, 0], "test14")
                            p[tosend_ID][topath_ID] += 1 / sender_.p2
                        elif ran_tmp == 15 and t[tosend_ID][topath_ID] > 0:
                            t[tosend_ID][topath_ID] -= 1
                            pack = Packet(self.packet_counter, topath_ID, self.cur_time, 0, [12, 26, 23, 21, 19, 2], "test15")
                            p[tosend_ID][topath_ID] += 1 / sender_.p3
                        elif ran_tmp == 16 and t[tosend_ID][topath_ID] > 0:
                            t[tosend_ID][topath_ID] -= 1
                            pack = Packet(self.packet_counter, topath_ID, self.cur_time, 0, [6, 17, 1], "test16")
                            p[tosend_ID][topath_ID] += 1 / sender_.p0
                        elif ran_tmp == 17 and t[tosend_ID][topath_ID] > 0:
                            t[tosend_ID][topath_ID] -= 1
                            pack = Packet(self.packet_counter, topath_ID, self.cur_time, 0, [6, 22, 25, 9], "test17")
                            p[tosend_ID][topath_ID] += 1 / sender_.p1
                        elif ran_tmp == 18 and t[tosend_ID][topath_ID] > 0:
                            t[tosend_ID][topath_ID] -= 1
                            pack = Packet(self.packet_counter, topath_ID, self.cur_time, 0, [6, 22, 25, 26, 11], "test18")
                            p[tosend_ID][topath_ID] += 1 / sender_.p2
                        elif ran_tmp == 19 and t[tosend_ID][topath_ID] > 0:
                            t[tosend_ID][topath_ID] -= 1
                            pack = Packet(self.packet_counter, topath_ID, self.cur_time, 0, [6, 20, 3], "test19")
                            p[tosend_ID][topath_ID] += 1 / sender_.p3
                        else:
                            push_new_event = False
                            p5 += 1/sender.p5
        ...
        for i in range(5):  # Loop through all 5 senders
            sender_mi = self.senders[i].get_run_data()
            throughput.append(sender_mi.get("recv rate") / (8 * BYTES_PER_PACKET))
            latency.append(sender_mi.get("avg latency"))
        ...
        for i in range(5):  # Loop through all 5 flows
            reward = (
                math.log(max(throughput[i], math.exp(-17.5)))  # Adjust for each throughput
                - 1.5 * math.log(max(latency[i], math.exp(-5)))  # Adjust for each latency
                - 0.5 * math.log(max(drop_total[i], 1))  # Adjust for each drop_total
            )
            reward_flows.append(reward)
        ...
        if REWARD_CONTROL == 0 :
            ...
            reward = sum(reward_flows)  # Sum up rewards for all flows
...
class SimulatedNetwork20dEnv(gym.Env):
    def __init__(self,
    ...
    def step(self, actions):
        ...
        if Sender0_mode == 0:
            ...
            actions = 25 * (np.array(actions) + 1 + 1e-6)
            """
            ...
            self.senders[0].p3 = actions[3]

            self.senders[1].p0 = actions[4]
            self.senders[1].p1 = actions[5]
            self.senders[1].p2 = actions[6]
            self.senders[1].p3 = actions[7]

            self.senders[2].p0 = actions[8]
            self.senders[2].p1 = actions[9]
            self.senders[2].p2 = actions[10]
            self.senders[2].p3 = actions[11]

            self.senders[3].p0 = actions[12]
            self.senders[3].p1 = actions[13]
            self.senders[3].p2 = actions[14]
            self.senders[3].p3 = actions[15]

            self.senders[4].p0 = actions[16]
            self.senders[4].p1 = actions[17]
            self.senders[4].p2 = actions[18]
            self.senders[4].p3 = actions[19]
            rate_sum = 0
            for i in range(5):
                for j in range(4):
                    rate_sum += max(0, actions[i * 4 + j])
    ...
    def create_new_links_and_senders(self):
        ...
        self.node_link7 = Link(7,bw0, lat, queue, loss,['AIL', 5],False,True)
        self.node_link8 = Link(8,bw0, lat, queue, loss,['UIL', 6],False,True)
        ...
        self.node_link14 = Link(14,bw0, lat, queue, loss,['PCA', 10],False,True)
        self.node_link15 = Link(15,bw0, lat, queue, loss,['SCA', 11],False,True)
        ...
        self.senders = [
            Sender(i, 1000, self.links[0], 0, self.features, history_len=self.history_len)
            for i in range(5)  # Create 5 senders dynamically
        ]
        self.run_dur = 5 * lat
...
register(id='PccNs_uti_NSFnet_multiV3-v0', entry_point='environments.NSFnet.NSFnet_multiV3:SimulatedNetwork20dEnv')
